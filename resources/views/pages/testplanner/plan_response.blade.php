    ...
    $(document).ready(function() {
        $('#submit-btn').on('click', function(e) {
            ...
            $('.ticket-panel').each(function () {
                ...
                var description   = $(this).find('.ticket-description').text();
                var testStatus    = $(this).find('input[type="radio"]:checked').val();
                var notesResponse = $(this).find('.notes_response').val();

                if (notesResponse == '') {
                    e.preventDefault();
                    tickets = [];
                    alert(description + ' notes cannot be empty.');
                    return false;
                }
                ...
                if (testStatus === undefined) {
                    e.preventDefault();
                    tickets = [];
                    alert(description + ' test status needs to be checked.');
                    return false;
                }
